...
def run_code(language, code, input_data):
    ...
    # For Java, use fixed filename Main.java; otherwise use UUID filename
    if language == "java":
        code_file = code_path / "Main.java"
    else:
    ...
    if language == "cpp":
        ...
        run_cmd = f"""
        javac /app/codes/Main.java && \\
        java -cp /app/codes Main < /app/inputs/{input_file.name} > /app/outputs/{output_file.name}
        """
    else:
